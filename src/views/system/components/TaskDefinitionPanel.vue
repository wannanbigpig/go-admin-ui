...
import { createTaskQuery } from '@/modules/system/model'
import { SYSTEM_DICT_TYPES, commonStatusFallbackOptions, yesNoFallbackOptions, taskKindFallbackOptions } from '@/modules/system/dictOptions'
import { fetchTaskList, triggerTaskNow } from '@/modules/system/service'
import { Logger } from '@/utils/logger'
import type { TableColumn } from '@/types/common'
import type { TaskDefinition, TaskTriggerPayload } from '@/types/system'
...
onMounted(async () => {
    await Promise.all([loadCommonStatusOptions(), loadYesNoOptions(), loadTaskKindOptions()])
    await getTaskList()
})
</script>
